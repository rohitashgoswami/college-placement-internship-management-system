...
const DECK_ID = "placement-demo";
const OUT_DIR = "C:\\xampp\\htdocs\\college-placement-internship-management-system\\.dist\\presentation\\placement-demo\\outputs";
const REF_DIR = "C:\\xampp\\htdocs\\college-placement-internship-management-system\\.dist\\presentation\\placement-demo\\tmp\\slides\\pro-reference-images";
...
const SOURCES = {
  readme: "README.md: local setup, database name, MySQL port, and default admin credentials.",
  schema: "backend/database.sql: admin, students, internships, applications, saved_jobs, and interview_rounds tables.",
  code: "PHP source files under backend/admin and backend/student.",
};

const SLIDES = [
  {
    kicker: "FINAL YEAR PROJECT DEMO",
    title: "College Placement & Internship Management System",
    subtitle: "A PHP and MySQL portal for managing opportunities, student applications, interview rounds, and placement reports.",
    moment: "Demo path: Home -> Login -> Student Flow -> Admin Flow -> Reports",
    notes: "Start by introducing the project as PlaceHub. Explain that it solves the manual work of posting opportunities, collecting applications, tracking student status, and preparing placement reports.",
    sources: ["readme", "code"],
  },
  {
    kicker: "PROJECT PURPOSE",
    title: "Why We Built It",
    subtitle: "The system connects students and placement administrators in one workflow.",
    cards: [
      ["Problem", "Manual placement tracking is slow, scattered, and hard to report."],
      ["Solution", "A single portal handles listings, applications, status updates, and reports."],
      ["Users", "Students apply and track progress; admins manage opportunities and results."],
    ],
    notes: "Tell the examiner that the project focuses on practical placement-cell operations: publishing internships or placements, letting students apply, and giving admins a dashboard for decisions.",
    sources: ["code"],
  },
  {
    kicker: "SCOPE",
    title: "Main Modules at a Glance",
    subtitle: "The application is divided into public, student, admin, and database modules.",
    metrics: [
      ["2", "Role-based areas: Student and Admin", "login.php routes users"],
      ["6", "Core database tables", "database.sql schema"],
      ["12+", "Feature pages across dashboards and workflows", "backend source"],
    ],
    notes: "Mention the important modules: public homepage, unified login, student registration, student dashboard, job board, saved jobs, applications, profile, admin dashboard, internship management, application review, interview rounds, and reports.",
    sources: ["schema", "code"],
  },
  {
    kicker: "STARTUP",
    title: "How to Start the Project",
    subtitle: "Use XAMPP with Apache and MySQL, then open the portal from localhost.",
    cards: [
      ["Database", "Import backend/database.sql into college_placement_system."],
      ["Connection", "MySQL uses localhost, root, blank password, and port 3307."],
      ["Launch", "Open /college-placement-internship-management-system/index.php."],
    ],
    notes: "Before the demo, start Apache and MySQL in XAMPP. Confirm that backend/config/db.php uses port 3307. The default admin login is username admin and password admin123.",
    sources: ["readme", "schema"],
  },
  {
    kicker: "ENTRY FLOW",
    title: "Public Pages and Login",
    subtitle: "The first screen shows latest opportunities and sends users to the right area.",
    cards: [
      ["Home", "index.php displays recent opportunities and login/register actions."],
      ["Unified Login", "login.php lets users choose Student or Admin from one form."],
      ["Registration", "Only student registration is public; admin accounts are seeded."],
    ],
    notes: "Demo this by opening the home page, clicking Login, switching between student and admin role fields, then showing Register for student-only signup.",
    sources: ["code", "readme"],
  },
  {
    kicker: "STUDENT SIDE",
    title: "Student Workflow",
    subtitle: "Students can discover opportunities, apply, save jobs, and track outcomes.",
    metrics: [
      ["5", "Dashboard counters for student progress", "student dashboard"],
      ["6", "Job board results per page", "pagination setting"],
      ["1", "Application per student per opportunity", "duplicate check"],
    ],
    notes: "After student login, show dashboard counters: active listings, applications, interviews or shortlisted, saved jobs, and selection rate. Then open the job board and demonstrate filters.",
    sources: ["code"],
  },
  {
    kicker: "STUDENT FEATURES",
    title: "What Students Can Do",
    subtitle: "The student area supports the complete application journey.",
    cards: [
      ["Profile", "Students maintain contact details, CGPA, skills, resume, and links."],
      ["Job Board", "Search, filter by type, location, deadline, and sort listings."],
      ["Tracker", "My Applications shows status and interview round timeline."],
    ],
    notes: "Show profile briefly if time allows. The key demo action is Apply Now. Explain that the application starts as Pending and then admin can update it.",
    sources: ["code", "schema"],
  },
  {
    kicker: "ADMIN SIDE",
    title: "Admin Workflow",
    subtitle: "Admins control listings, student records, applications, and reports.",
    cards: [
      ["Dashboard", "Shows totals, pending reviews, alerts, recent activity, and search."],
      ["Internships", "Admins add, manage, and delete internship or placement listings."],
      ["Applications", "Admins filter records, select, reject, or manage interview rounds."],
    ],
    notes: "Login as admin with admin/admin123. Show system overview, quick actions, global search, and alerts for pending reviews, expired listings, and closing deadlines.",
    sources: ["readme", "code"],
  },
  {
    kicker: "STATUS FLOW",
    title: "Application and Interview Lifecycle",
    subtitle: "Applications move from submission to admin decision with round tracking.",
    metrics: [
      ["Pending", "Default status after student applies", "applications table"],
      ["Interview", "Set when rounds are active", "application_rounds.php"],
      ["Selected", "Final successful outcome used in reports", "reports.php"],
    ],
    notes: "Explain that apply.php prevents duplicate applications. Admin can mark Selected or Rejected from View Applications. For deeper tracking, Application Rounds stores round number, title, schedule, status, and remarks.",
    sources: ["schema", "code"],
  },
  {
    kicker: "REPORTING",
    title: "Reports and Placement Insights",
    subtitle: "The reports page converts operational data into presentation-ready numbers.",
    cards: [
      ["Summary", "Total students, internships, applications, selections, and rate."],
      ["Breakdowns", "Application status and internship type distributions."],
      ["Performance", "Recruiter activity and top student participation lists."],
    ],
    notes: "Open reports.php in the admin area. Tell the examiner that all values are calculated live from MySQL queries, so reports update whenever applications or statuses change.",
    sources: ["code"],
  },
  {
    kicker: "IMPLEMENTATION",
    title: "How We Implemented It",
    subtitle: "The project uses PHP, MySQL, sessions, reusable includes, and Tailwind styling.",
    cards: [
      ["Backend", "PHP pages process forms, run MySQL queries, and redirect after actions."],
      ["Security", "Sessions protect student/admin pages; passwords use hashing for students."],
      ["UI", "Tailwind CSS builds responsive dashboards, cards, forms, and tables."],
    ],
    notes: "Point out backend/config/db.php, includes/admin_auth.php, includes/student_auth.php, flash messages, shared layout files, and pagination helper. Mention that mysqli_real_escape_string is used in many form and filter queries.",
    sources: ["code"],
  },
  {
    kicker: "LIVE DEMO SCRIPT",
    title: "Recommended Demonstration Order",
    subtitle: "Follow this sequence to show the project clearly within limited time.",
    cards: [
      ["1. Student", "Register or login, browse job board, save a job, and apply."],
      ["2. Admin", "Add a listing, review the student application, update status."],
      ["3. Result", "Show student tracker, interview rounds, reports, and future scope."],
    ],
    notes: "End with future scope: email notifications, resume parsing, company login, exportable reports, stronger prepared statements, and deployment on a hosted server.",
    sources: ["code", "readme"],
  },
];
...
async function slideCover(presentation) {
  ...
  addShape(slide, "roundRect", 86, 448, 460, 120, PAPER_96, INK, 1.2, { slideNo, role: "cover moment panel" });
  addText(slide, slideNo, data.moment || "Replace with core idea", 112, 472, 408, 74, {
    size: 21,
    color: INK,
    bold: true,
    face: TITLE_FACE,
...
async function slideCards(presentation, idx) {
  ...
  for (let cardIdx = 0; cardIdx < cols; cardIdx += 1) {
    ...
    addCard(slide, idx, x, 402, cardW, 204, label, body, { iconKind: iconKinds[cardIdx % iconKinds.length] });
  }
